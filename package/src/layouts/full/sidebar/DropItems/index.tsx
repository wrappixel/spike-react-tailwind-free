  ...
  return (
    <>
      <Link 
        ...
        className={`realtive flex items-center h-10 relative py-2 ps-6 pe-4 rounded-full transition-all duration-300 ${
          item.url == pathname
            ? `text-primary bg-primary/10 active`
            : `text-dark/80 dark:text-white/60 bg-transparent hover:text-primary hover:bg-primary/5`
        }`}
      >
